      ...
      <div className="space-y-8">
        <section className="bg-gray-100 p-6 rounded-xl shadow">
          ...
          <p className="mb-4">
            ...
            requires more than just hard work; it requires the right support and
            expertise.
          </p>
          <p>
            That’s why we offer a comprehensive suite of professional services
            designed to help you streamline your operations, enhance your online
            presence, and make informed decisions that drive growth. Whether
            you’re a small startup or an established enterprise, our dedicated
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            today to learn more about how Sharp Gbs can support your growth and
            success. Our friendly team is here to answer your questions and
