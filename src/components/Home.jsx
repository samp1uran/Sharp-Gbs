        ...
        <section className="bg-gray-100 p-6 rounded-xl shadow">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <p className="md:w-1/2 text-lg text-gray-700 leading-relaxed">
              ...
              designed to help you streamline your operations, enhance your
              online presence, and make informed decisions that drive growth.
              Whether you’re a small startup or an established enterprise, our
              dedicated team is here to provide tailored solutions that meet
              your unique needs.
            </p>
